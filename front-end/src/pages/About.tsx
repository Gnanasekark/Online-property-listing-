      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-gray-600 mb-4 leading-relaxed">
              Founded with a vision to revolutionize the real estate industry, EstateHub has grown into one of the most trusted names in property management and sales. We believe everyone deserves to find their dream home without the hassle of traditional real estate processes.
            </p>
            <p className="text-gray-600 mb-4 leading-relaxed">
            ...
            <p className="text-gray-600 leading-relaxed">
              Whether you're looking for your first apartment, a family home, or a luxury villa,  EstateHub is here to guide you every step of the way.
            </p>
          </div>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl p-12 text-white text-center">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied customers who found their perfect property through  EstateHub
          </p>
          <a
            href="/properties"
