...
// ⭐ Search control for React Leaflet
            ...
            >
              <Popup className="max-w-xs">
                <div className="flex flex-col items-center">
                  <img src={imageUrl} alt={property.title} className="w-48 h-32 object-cover rounded-lg mb-2" />
                  <h3 className="font-bold text-gray-800">{property.title}</h3>
                  <p className="text-gray-600 font-medium mb-2">₹{property.price?.toLocaleString('en-IN')}</p>
                  <button
